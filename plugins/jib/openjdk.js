        ...
        builds: [
            {
                ...
                extract: {
                    format: "tar",
                    targetPath: path_1.posix.join(jdk8Version, "Contents", "Home"),
                },
            },
            {
                platform: "linux",
        ...
        builds: [
            {
                ...
                extract: {
                    format: "tar",
                    targetPath: path_1.posix.join(jdk11Version, "Contents", "Home"),
                },
            },
            {
                platform: "linux",
        ...
        builds: [
            {
                ...
                extract: {
                    format: "tar",
                    targetPath: path_1.posix.join(jdk13Version, "Contents", "Home"),
                },
            },
            {
                platform: "linux",
...
//# sourceMappingURL=openjdk.js.map